...
class HomeController extends Controller
{
    ...
    public function product_view($id)
    {
        ...
        $this->data['related_products'] = Product::where('cat_id', $cat_id)->where('status',1)->limit(12)->get();
    ...
    public function cat_shop($id)
    {
        ...
        $this->data['subcategories'] = Subcategory::all();
        $this->data['brands'] = Brand::all();
        $this->data['products'] = Product::where('cat_id', $id)->where('status',1)->limit(12)->get();
        $top_sales = DB::table('products')
            ->leftJoin('order_details','products.id','=','order_details.product_id')
            ->selectRaw('products.id, SUM(order_details.product_sales_quantity) as total')
            ->groupBy('products.id')
    ...
    public function subcat_shop($id)
    {
        ...
        $this->data['subcategories'] = Subcategory::all();
        $this->data['brands'] = Brand::all();
        $this->data['products'] = Product::where('subcat_id', $id)->where('status',1)->limit(12)->get();
    ...
    public function brand_shop($id)
    {
        ...
        $this->data['subcategories'] = Subcategory::all();
        $this->data['brands'] = Brand::all();
        $this->data['products'] = Product::where('brand_id', $id)->where('status',1)->limit(12)->get();
